...
import { IsBoolean, IsDefined, IsEmail, IsNotEmpty, IsNumber, IsString, MaxLength } from "class-validator";
...
export class CreateUsuarioDto {
    ...
    @IsNumber({},{ message: 'El campo email debe ser de tipo verdadero o falso' })
